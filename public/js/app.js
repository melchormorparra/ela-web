...
function applyContentBlocks() {
    ...
    const map = {
        ...
        conocenos_titulo: '#conocenos .section-title',
        conocenos_subtitulo: '#conocenos .section-subtitle',
        conocenos_texto: '#conocenos .conocenos-content',
        mision_titulo: '#mision .section-title',
        mision_texto: '#mision .mision-content',
        como_ayudar_titulo: '#como-ayudar .section-title',
        como_ayudar_texto: '#como-ayudar .como-ayudar-content',
