...
const initialData = {
  admin: { password: 'ela2026', email: 'Neuronasconchispa@gmail.com' },
  products: [
  ...
  users: [],
  config: {
    paypalEmail: 'Neuronasconchispa@gmail.com',
    bizumPhone: 'ES3921004823032200362949',
    bankAccount: { holder: 'Neuronas con Chispa', iban: 'ES3921004823032200362949' },
