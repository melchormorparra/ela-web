...
async function seedData() {
    ...
    const allBlocks = [
        ...
        { block_key: 'conocenos_titulo', title: 'T\u00edtulo Con\u00f3cenos', content: 'Con\u00f3cenos' },
        { block_key: 'conocenos_subtitulo', title: 'Subt\u00edtulo Con\u00f3cenos', content: '\u00bfPor qu\u00e9 Neuronas con Chispa?' },
        { block_key: 'conocenos_texto', title: 'Texto Con\u00f3cenos', content: '<p>Neuronas con Chispa nace de la necesidad de dar visibilidad a la ELA y crear una comunidad de apoyo. Creemos que cada peque\u00f1a acci\u00f3n cuenta y que juntos podemos marcar la diferencia en la vida de las personas afectadas.</p>' },
        { block_key: 'mision_titulo', title: 'T\u00edtulo Nuestra Misi\u00f3n', content: 'Nuestra misi\u00f3n' },
        { block_key: 'mision_texto', title: 'Texto Nuestra Misi\u00f3n', content: '<p>Trabajamos para financiar investigaci\u00f3n m\u00e9dica, ofrecer apoyo psicol\u00f3gico y emocional a familias, y concienciar a la sociedad sobre la realidad de la ELA. Nuestra meta es un futuro sin esta enfermedad.</p>' },
        { block_key: 'como_ayudar_titulo', title: 'T\u00edtulo C\u00f3mo Puedes Ayudar', content: 'C\u00f3mo puedes ayudar' },
        { block_key: 'como_ayudar_texto', title: 'Texto C\u00f3mo Puedes Ayudar', content: '<p>Puedes colaborar con nosotros de muchas formas: haci\u00e9ndote colaborador mensual, realizando una donaci\u00f3n puntual, comprando en nuestra tienda solidaria o difundiendo nuestro mensaje en tus redes sociales. Cada gesto suma.</p>' },
        ...
        { block_key: 'contact_address_visible', title: 'Mostrar direcci\u00f3n', content: 'false' },
        { block_key: 'contact_phone_visible', title: 'Mostrar tel\u00e9fono', content: 'false' },
        { block_key: 'contact_email_visible', title: 'Mostrar email', content: 'false' },
        { block_key: 'social_facebook_visible', title: 'Mostrar Facebook', content: 'false' },
        { block_key: 'social_twitter_visible', title: 'Mostrar Twitter / X', content: 'false' },
        { block_key: 'social_instagram_visible', title: 'Mostrar Instagram', content: 'false' },
        { block_key: 'social_youtube_visible', title: 'Mostrar YouTube', content: 'false' },
